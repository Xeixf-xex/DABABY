...
express.get("/affiliate/api/public/affiliates/slug/:slug", async (req, res) => {
	if (req.params.slug.toLowerCase() == "Xex")
	{
...
express.get("/account/api/public/account", async (req, res) => {
	res.json(
			...
			{
			  "id": "SubtoXeixf_LOL123",
			  "displayName": "Subscribe to Xeixf on YouTube!",
			  "externalAuths": {
				"xbl": {
				  "type": "xbl",
				  "externalAuthIdType": "xuid",
				  "accountId": "SubtoXeixf_LOL123",
				  "externalDisplayName": "YouTube-Xeixf",
				  "authIds": [
					{
					  "id": "0",
					  "type": "xuid"
			...
			{
			  "id": "FollowXeixf_LOL123",
			  "displayName": "Follow @xeixf on tiktok!",
			  "externalAuths": {
				"xbl": {
				  "type": "xbl",
				  "externalAuthIdType": "xuid",
				  "accountId": "FollowXex_LOL123",
				  "externalDisplayName": "TikTok-Xex",
				  "authIds": [
					{
					  "id": "0",
					  "type": "xuid"
...
express.get("/account/api/public/account/:accountId", async (req, res) => {
	res.json(
	{
		...
		"name": "Xex",
		"email": req.params.accountId + "@xex.com",
...
express.post("/account/api/oauth/token", async (req, res) => {
	...
	res.end();
		...
		express.post("/fortnite/api/game/v2/profile/*/client/SetAffiliateName", async (req, res) => {
			...
			if (req.body.affiliateName.toLowerCase() == "xex" && profile.profileId == "common_core")
			{
